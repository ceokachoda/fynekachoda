            ...
            <View>
              {isLoading ? (
                <View className="bg-white rounded-[28px] p-5 mb-4 shadow-sm shadow-slate-200/50 border border-slate-100">
                  ...
                  <Skeleton width={150} height={16} borderRadius={4} className="mb-6" />
          ...
          {activeTab === 'upcoming' && (
            <View>
              {isLoading ? (
                <>
                  {[1, 2].map(i => (
                    <View key={i} className="bg-white rounded-[28px] p-5 mb-4 shadow-sm shadow-slate-200/50 border border-slate-100">
                      <View className="flex-row justify-between items-start mb-4">
                        <Skeleton width={80} height={28} borderRadius={8} />
                        <Skeleton width={110} height={20} borderRadius={4} />
                      </View>
          ...
          {activeTab === 'recorded' && (
            <View>
              {isLoading ? (
                <>
                  {[1, 2].map(i => (
                    <View key={i} className="bg-white rounded-[28px] p-4 mb-4 shadow-sm shadow-slate-200/50 border border-slate-100 flex-row items-center">
                      <Skeleton width={96} height={96} borderRadius={16} />
                      <View className="flex-1 ml-4 justify-center">
                        <Skeleton width={80} height={12} borderRadius={4} className="mb-2" />
                        <Skeleton width="90%" height={20} borderRadius={4} className="mb-2" />
                        <Skeleton width={120} height={16} borderRadius={4} />
                      </View>
                    </View>
                  ))}
