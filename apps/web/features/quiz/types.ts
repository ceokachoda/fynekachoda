// Shapes returned by the Phase 6 edge functions
// (apps/functions/quiz-{start,submit,attempt-result}/index.ts). Mirrors
// apps/mobile/features/quiz/types.ts so the web client speaks the same wire
// protocol as the mobile client.
