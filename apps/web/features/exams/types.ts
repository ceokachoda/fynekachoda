// Shapes returned by the Phase 7 exam-* edge functions
// (apps/functions/exam-{start,submit,attempt-result,tab-switch}/index.ts).
// Mirrors apps/mobile/features/exam/types.ts.
