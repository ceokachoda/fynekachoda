...
// Password field with a show/hide toggle. Forwards every prop (value,
// onChange, name, ref, aria-*) straight through to the underlying Input so it
// works for controlled, uncontrolled, and react-hook-form usages alike.
