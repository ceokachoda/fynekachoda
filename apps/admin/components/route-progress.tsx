 ...
 * The bar is held on screen for a minimum duration so that fast (prefetched)
 * navigations are still clearly visible, and a safety timeout guarantees it can
 * never hang on an edge case.
 */
    ...
    >
      <div
        style={{
          ...
          width: `${progress}%`,
          background:
            "linear-gradient(90deg, #1d4ed8 0%, #3b82f6 45%, #06b6d4 100%)",
      ...
      >
        {/* Glowing leading edge (the classic loading-bar "peg"). */}
        <span
          style={{
            position: "absolute",
            right: 0,
            ...
            borderRadius: "9999px",
            boxShadow:
              "0 0 14px 2px rgba(59, 130, 246, 0.9), 0 0 8px 1px rgba(6, 182, 212, 0.8)",
            opacity: 0.85,
          }}
        />
      </div>
